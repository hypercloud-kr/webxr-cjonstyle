    ...
    <StartingWrapper>
      ...
      <ImgWrapper>
        <PrecautionUl>
          ...
          <li>
            네트워크 환경에 따라 AR 증강현실 로딩에<br></br>
            10초 이상의 시간이 소요될 수 있습니다.
          </li>
          <li>
            사용자 디바이스가 물리적으로 불안정할 경우 <br></br>
            AR 증강현실 체험이 어려울 수 있습니다.
          </li>
          <li>
            AR 콘텐츠 사용 시 주변 장애물이나 안전에 <br></br>
            주의하시기 바랍니다.
          </li>
          <li>
            CJ온스타일 회원이 아니라면 참여하신 <br></br>
            게임 점수가 사라집니다. 회원가입하시고 <br></br>
            경품에 도전하세요!
          </li>
        </PrecautionUl>
